...
class SellerMarketReviewAdapter(private var reviewItems:ArrayList<SellerMarketReviewData>,var flag : Int):RecyclerView.Adapter<SellerMarketReviewViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SellerMarketReviewViewHolder, position: Int) {
        holder.review_name.text = reviewItems[position].review_name
        holder.review.text = reviewItems[position].review
