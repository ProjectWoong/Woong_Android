...
class Join1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_next_marketer_join1.setOnClickListener {
            val intent = Intent(applicationContext, Join2Activity::class.java)
            startActivity(intent)   // 전환될 액티비티로 넘어갈때
        }

        //Spinner
        val spnYear = findViewById(R.id.spinner_year_marketer) as Spinner
        val spnMonth = findViewById(R.id.spinner_month_marketer) as Spinner
        val spnDay = findViewById(R.id.spinner_day_marketer) as Spinner
