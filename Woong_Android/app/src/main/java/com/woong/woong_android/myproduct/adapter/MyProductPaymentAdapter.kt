...
class MyProductPaymentAdapter(private var paymentItems : ArrayList<GetCartResponseData>) : RecyclerView.Adapter<MyProductPaymentViewHolder>() {
...
//        holder.name.text = paymentItems[position].pm_name
    }
